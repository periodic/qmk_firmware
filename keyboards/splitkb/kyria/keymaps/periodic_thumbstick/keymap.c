 ...
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |      |  |Compose| GAME |   k  |   m  | ,  < | . >  | /  ? | RShift |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 ...
 */
    [_COLEMAK] = LAYOUT(
      ...
      KC_LSFT,              KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  _______,   _______, KC_RALT, G_ON,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
              KC_LGUI,
              MO(_UTIL),
              MO(_MOVE),
              KC_BSPC,
 ...
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |        | KP * | KP 1 | KP 2 | KP 3 | KP + |                              | Home | PgDn | PgUp | End  |      |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        | KP - | KP 4 | KP 5 | KP 6 | KP 0 |                              | Left | Down | Up   | Right|      |        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        | KP . | KP 7 | KP 8 | KP 9 | KP = |      |      |  |      |      | MLeft| Mdown| MUp  |MRight| KP / |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      | Num  | TRNS | Del  |      |  | KC   |      |      |      |      |
 *                        |      | Lock |      |      |      |  | Ent  |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_MOVE] = LAYOUT(
      _______, KC_PAST, KC_P1,   KC_P2,   KC_P3,   KC_PPLS,                                     KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
      _______, KC_PMNS, KC_P4,   KC_P5,   KC_P6,   KC_P0,                                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
      _______, KC_PDOT, KC_P7,   KC_P8,   KC_P9,   KC_PEQL, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_PSLS, _______,
                                 _______, KC_NUM,  KC_TRNS, KC_DEL,  _______, KC_PENT, _______, _______, _______, _______
    ),
 /*
 ...
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |      | Prev | Play | Next |      |                              |QWERTY| COLE |      |      |      | F12    |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |      | Mute |VolDn |VolUp |      |      |      |  |      |      |      | GNext|      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_UTIL] = LAYOUT(
      ...
      _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,                                     TG(_MAC), TO(_COLEMAK), _______, _______, _______, KC_F12,
      _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, _______, G_NEXT,  _______, _______, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
/*
 * ARPG - Action RPGs
 ...
 */
    [_ARPG] = LAYOUT(
      ...
      KC_LCTL,              KC_MINS, KC_0,    KC_9,    KC_8,    KC_Y,    _______, _______, _______, G_OFF,   _______, _______, _______, _______, _______, _______,
 ...
 */
    [_MMORPG] = LAYOUT(
      ...
      KC_LCS,  KC_LSFT, KC_MINS, KC_0,    KC_9,    KC_B, _______, _______,  _______, G_OFF,   _______, _______, _______, _______, _______, _______,
 ...
 */
    [_FPS] = LAYOUT(
      ...
      KC_B              ,  KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V, _______, _______, _______, G_OFF,    _______, _______, _______, _______, _______, _______,
