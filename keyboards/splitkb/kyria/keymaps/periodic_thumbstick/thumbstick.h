...
typedef enum {
    ...
    THUMBSTICK_MODE_NUMBERS,
    THUMBSTICK_MODE_SCROLL,
    _THUMBSTICK_MODE_LAST  // Do not use, except for looping through enum values
} thumbstick_mode_t;

// Parameters
#define THUMBSTICK_DEAD_ZONE 100   // Values below this are ignored (deadzone)
#define THUMBSTICK_FINE_ZONE 200  // Values below this enable fine movement

#define THUMBSTICK_MODE THUMBSTICK_MODE_ARROWS
...
#define THUMBSTICK_TIMEOUT 20          // Input throttling
